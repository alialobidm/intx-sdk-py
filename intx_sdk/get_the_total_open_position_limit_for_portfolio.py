...
@dataclass
class GetTheTotalOpenPositionLimitForPortfolioResponse(BaseResponse):
    request: GetTheTotalOpenPositionLimitForPortfolioRequest
...
class IntxClient:
    ...
    def get_the_total_open_position_limit_for_portfolio(self, request: GetTheTotalOpenPositionLimitForPortfolioRequest) -> GetTheTotalOpenPositionLimitForPortfolioResponse:
        ...
        return GetTheTotalOpenPositionLimitForPortfolioResponse(response.json(), request)
