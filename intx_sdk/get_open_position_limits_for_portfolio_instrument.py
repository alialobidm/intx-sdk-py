...
@dataclass
class GetOpenPositionLimitsForPortfolioInstrumentResponse(BaseResponse):
...
class IntxClient:
    ...
    def get_open_position_limits_for_portfolio_instrument(self, request: GetOpenPositionLimitsForPortfolioInstrumentRequest) -> GetOpenPositionLimitsForPortfolioInstrumentResponse:
        ...
        return GetOpenPositionLimitsForPortfolioInstrumentResponse(response.json(), request)
