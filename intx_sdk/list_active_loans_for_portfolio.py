...
@dataclass
class ListActiveLoansForPortfolioResponse(BaseResponse):
    request: ListActiveLoansForPortfolioRequest
...
class IntxClient:
    ...
    def list_active_loans_for_portfolio(self, request: ListActiveLoansForPortfolioRequest) -> ListActiveLoansForPortfolioResponse:
        ...
        return ListActiveLoansForPortfolioResponse(response.json(), request)
