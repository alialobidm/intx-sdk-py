...
@dataclass
class ListOpenPositionLimitsForAllInstrumentsResponse(BaseResponse):
    request: ListOpenPositionLimitsForAllInstrumentsRequest
...
class IntxClient:
    ...
    def list_open_position_limits_for_all_instruments(self, request: ListOpenPositionLimitsForAllInstrumentsRequest) -> ListOpenPositionLimitsForAllInstrumentsResponse:
        ...
        return ListOpenPositionLimitsForAllInstrumentsResponse(response.json(), request)
