...
from intx_sdk.services.portfolios import ListOpenPositionLimitsForAllInstrumentsRequest
...
def main():
    ...
    try:
        ...
        print(f"failed to list open position limits for all instruments: {e}")
