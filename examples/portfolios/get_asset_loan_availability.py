...
from intx_sdk.services.portfolios import GetAssetLoanAvailabilityRequest
...
def main():
    ...
    try:
        response = client.portfolios.get_asset_loan_availability(request)
        print(response)
    except Exception as e:
        print(f"failed to get asset loan availability: {e}")
